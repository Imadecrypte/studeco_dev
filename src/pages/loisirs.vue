...
<template>
  <div class="font-jost p-5">
    <h1 class="text-2xl font-bold font-alata mb-3 text-[#DFB374] text-center">LOISIRS</h1>
    <div class="p-5 rounded">
      <img src="/Loisirs_plage.webp" alt="Food Image" class="mx-auto" />
    </div>
    <p class="mt-5">Bienvenue dans le thème des loisirs, viens découvrir toutes les offres disponibles !</p>
    ...
    <div class=" relative border border-gray-300 rounded-lg my-5">
      <div class="flex justify-center relative z-10">
        <img src="/Popcorn.webp" alt="Food Offer Image" class="w-[350px] -mb-[90px] relative z-10" />
      </div>
      <div class="bg-[#dc5746] p-5 rounded mt-5 pt-20 text-center">
        <div class="text-xl font-bold mt-5">8,50 € POUR TOUTES LES SÉANCES</div>
        <div class="text-lg my-2">
          <p>Kinépolis Belfort</p>
          <p>1 boulevard Richelieu</p>
          <p>90000 Belfort</p>
        </div>
        <a href="https://www.kinepolis.fr" target="_blank" class="">
