...
<template>
  ...
  <div class="w-full max-w-[345px] h-[172px] mx-auto mt-[20px] relative">
    ...
    <p class="absolute left-9 top-[56px] text-[10px] text-left text-white w-[185px] h-[66px]">
  ...
  <div class="w-full max-w-[345px] h-[172px] mx-auto mt-[20px] relative">
    ...
    <p class="absolute left-[34px] top-[56px] text-[10px] text-left text-white w-[170px]">
